...
class TestGroqE2E(unittest.TestCase):
    ...
    def test_groq_api_key_valid(self):
        ...
        print(f"\nTesting API key: {api_key[:4]}...{api_key[-4:]}")  # Show first/last 4 chars only
        response = httpx.get(
    ...
    def test_shield_mode(self):
        ...
        for fixture in fixtures_dir.glob("*.sh"):
            with self.subTest(fixture=fixture.name):
                ...
                self.assertLessEqual(abs(actual_score - expected_score), 2, 
                ...
                if actual_score >= 6:
                    ...
                    self.assertEqual(shield_result.returncode, 0, "Shield mode should pass through safe scripts")
